...
function renderPetDetails(pet) {
    $("#pet-profile").html(`
		...
		<ul>
				...
				<li>Does ${pet.petName} behave well around other dogs?: ${
        pet.petBehavior.dogs
    }</li>
				<li>Does ${pet.petName} behave well around other cats?: ${
        pet.petBehavior.cats
    }</li>
				<li>Does ${pet.petName} behave well around children?: ${
        pet.petBehavior.children
    }</li>
				<li>Does ${
                    pet.petName
                } behave well around other kinds of pets? (birds, hamsters, reptiles etc.): ${
